...
| 公网部署现状 | 已通过 Railway + GitHub 仓库部署并可访问 |
...
1. 《高等数学上册_知识图谱_全书版》：7 章，124 个知识点
...
当前系统已从“前端触发 DeepSeek 分析”切换为“后台自动本地分析”。
...
7. 学习计划接口已支持 `book_ids`，多书计划会自动走交叉调度 fallback 链路
